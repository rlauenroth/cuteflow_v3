...
abstract class BaseSystemConfigurationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'send_reminder_mail'    => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'send_reminder_mail'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
