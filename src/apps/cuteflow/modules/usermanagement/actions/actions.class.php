...
class usermanagementActions extends sfActions
{
    ...
    public function executeUpdateUser(sfWebRequest $request)
    {
        ...
        UserSettingTable::getInstance()->updateUserEmailFormatAndEmailtype($data, $request->getParameter('id'));
        isset($data['userThirdTab_street']) ? UserDataTable::instance()->updateUserAdditinalData($data, $request->getParameter('id')) : '';
        isset($data['userSecondTab_durationlength_type']) ? UserSettingTable::getInstance()->updateUserSettingDurationTypeAndDurationLength($data, $request->getParameter('id')) : '';
        isset($data['userFourthTab_itemsperpage']) ? UserSettingTable::getInstance()->updateUserSetting($data, $request->getParameter('id')) : '';
    ...
    public function executeSaveUser(sfWebRequest $request)
    {
        ...
        UserSettingTable::getInstance()->updateUserSettingDurationTypeAndDurationLength($data, $user_id);
        UserDataTable::instance()->updateUserAdditinalData($data, $user_id);
        UserSettingTable::getInstance()->updateUserSetting($data, $user_id);
